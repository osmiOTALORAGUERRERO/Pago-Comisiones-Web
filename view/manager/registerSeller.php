      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          <ul class="navbar-nav mr-auto nav-tabs">
            <li class="nav-item">
              <a class="nav-link active text-dark" href="#">Registes employees <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        ...
        <form class="form" action=<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?> method="post">
          ...
          <div class="form-group row">
            <label for="contrato">Type of contract</label>
            <select class="form-control" name="recruitment" required>
              <option disabled selected>Selecct an option</option>
